...
if __name__ == '__main__':
    train_n_dw_matrix, test_n_dw_matrix, _, _, doc_occurences, doc_cooccurences = prepare_twitter_sentiment140_dataset('/home/tylorn/training.1600000.processed.noemoticon.csv', calc_cooccurences=True, train_test_split=0.8)
    D, W = train_n_dw_matrix.shape

    print D, W

    doc_cooccurences = scipy.sparse.csr_matrix((doc_cooccurences.values(), zip(*doc_cooccurences.keys())))
    ...
    args_list = [
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_base_0_0.pkl'
        ),
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_artm_0_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_artm_0_0_cheat.pkl'
        ),
        (
            em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_base_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_artm_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_artm_-0.1_0_cheat.pkl'
        ),
        (
            em_optimization, 
            20, 100, 20,
        ...
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_base_0_-0.1.pkl'
        ),
        (
            em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_artm_0_-0.1.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_20t_artm_0_-0.1_cheat.pkl'
        ),
        ...
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_base_0_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_artm_0_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_artm_0_0_cheat.pkl'
        ),
        (
            em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_base_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_artm_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_artm_-0.1_0_cheat.pkl'
        ),
        (
            em_optimization, 
            50, 100, 20,
        ...
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_base_0_-0.1.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_artm_0_-0.1.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'twitter_experiment/twitter_50t_artm_0_-0.1_cheat.pkl'
        )
    ]
