...
if __name__ == '__main__':
    ...
    doc_cooccurences = scipy.sparse.csr_matrix((data, (row, col)))
    del row
    del col
    del data
    ...
    args_list = [
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_base_0_0.pkl'
        ),
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_artm_0_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_artm_0_0_cheat.pkl'
        ),
        (
            em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_base_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_artm_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_artm_-0.1_0_cheat.pkl'
        ),
        (
            em_optimization, 
            20, 100, 20,
        ...
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_base_0_-0.1.pkl'
        ),
        (
            em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_artm_0_-0.1.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            20, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_20t_artm_0_-0.1_cheat.pkl'
        ),
        ...
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_base_0_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_artm_0_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_artm_0_0_cheat.pkl'
        ),
        (
            em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_base_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_artm_-0.1_0.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_artm_-0.1_0_cheat.pkl'
        ),
        (
            em_optimization, 
            50, 100, 20,
        ...
        (
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_base_0_-0.1.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_artm_0_-0.1.pkl'
        ),
        (
            artm_thetaless_em_optimization, 
            50, 100, 20,
            ...
            train_n_dw_matrix, test_n_dw_matrix,
            doc_occurences, doc_cooccurences,
            'nips_experiment/NIPS_50t_artm_0_-0.1_cheat.pkl'
        )
    ]
